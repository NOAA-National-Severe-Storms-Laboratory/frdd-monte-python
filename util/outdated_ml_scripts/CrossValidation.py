...
for date in np.unique( dateColumn1 ): 
	print date 
	X_train, y_train , X_test, y_test = cross_validation_split( examples1, binary1, dateColumn1, date )
...
np.savez_compressed( filename, AUCs, bss, POFDs, PODs, RelX, RelY, np.unique(dateColumn), SRs )
